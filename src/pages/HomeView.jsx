    ...
    <>
      ...
      <div className="bg-primary text-white py-5 position-relative overflow-hidden" style={{ minHeight: '80vh', display: 'flex', alignItems: 'center' }}>
        ...
        <Container className="position-relative text-center" style={{ zIndex: 1 }}>
          ...
          <div className="d-flex justify-content-center gap-3">
            <Button 
              variant="warning" size="lg" className="fw-bold px-5 rounded-pill shadow-lg"
            ...
            {!user && (
              <Button 
                variant="outline-light" size="lg" className="fw-bold px-5 rounded-pill"
      ...
      <Container className="py-5">
        <Row className="text-center mb-5">
          <Col><h2 className="fw-bold">Mengapa Memilih Kami?</h2></Col>
        </Row>
        <Row className="g-4">
          {[
            { icon: Users, title: "Tutor Profesional", desc: "Lulusan PTN ternama berpengalaman." },
            { icon: BookOpen, title: "Modul Lengkap", desc: "Materi update kurikulum Merdeka." },
