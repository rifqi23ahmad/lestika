    ...
    <div className="p-6 max-w-6xl mx-auto">
        ...
        <h3 className="font-semibold mb-4 text-gray-700 flex items-center">
          {isEditing ? (
            <span className="text-indigo-600 flex items-center">
              <Save size={18} className="mr-2" /> Edit Paket
            </span>
          ) : (
            "Tambah Paket Baru"
          )}
        ...
        >
          <div>
            ...
            <input
              ...
              placeholder="Contoh: SD Eksklusif"
            />
          </div>
          <div>
            <label className="block text-sm text-gray-600 mb-1">
          ...
          <div className="col-span-2">
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full p-2 border rounded focus:ring-2 focus:ring-blue-200 outline-none"
              placeholder="Fitur A, Fitur B, Fitur C"
            />
          </div>
      ...
      >
        <Modal.Body className="text-center p-4">
          ...
          <Button
            variant={infoModalData.type === "success" ? "success" : "danger"}
